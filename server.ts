  ...
  if (!apiKey || apiKey === "MY_GEMINI_API_KEY") {
    ...
    res.json({
      recommendation: {
        ...
        sommelierNote: "Designed around deep water salinity and mineral complexities, paired with coastal vintages.",
        courses: [
          {
            ...
            notes: "Vibrant acidity cuts through natural oyster brine with flinty minerality."
          },
          {
            ...
            notes: "Creamy textures elevate the tuna fat while subtle oak frames truffle notes."
          },
          {
          ...
          },
          {
            ...
            pairing: "2018 Pinot Noir 'Reserve', Domaine Serene, Willamette Valley",
            notes: "Silky tannins and red fruit notes contrast dark oceanic umami."
          },
          {
            course: "Course 5: Dessert",
            dish: "Bioluminescent Yuzu Sphere with Dark Chocolate Pearl",
            pairing: "Château d'Yquem 2015 Sauternes",
            notes: "Honeyed citrus complexity pairs with luminous dark chocolate crisp."
          }
        ]
      }
    });
...
Output valid JSON only with no markdown formatting around it if possible, or clean JSON string.`;
    ...
    res.json({
      recommendation: {
        ...
        sommelierNote: "A handcrafted journey through pristine oceanic flavors and rare coastal vintages.",
        courses: [
          {
            course: "Course 1",
            dish: "Kumbaja Oyster & Smoked Sea Foam",
            pairing: "Krug Grande Cuvée 170th Edition Champagne",
            notes: "Effervescent brilliance balancing sea salt and rich brioche notes."
          },
          {
            course: "Course 2",
          ...
          },
          {
            ...
            notes: "Rich botrytis sweetness balancing bitter ceremonial matcha."
          }
        ]
      }
    });
...
async function start() {
  ...
  app.listen(PORT, "0.0.0.0", () => {
    console.log(`[Abyssal Elegance] Server listening at http://0.0.0.0:${PORT}`);
  });
}
